...
class GRPCMessagingSendingTestCase(GRPCMessagingTestCase):
    ...
    def test_sending_nothing(self):
        ...
        self.componentA.invoke_procedure(self.profileB, 'helloworld', {}, {})
    ...
    def test_sending_args(self):
        ...
        self.componentB.add_procedure('helloworld', on_helloworld)
        self.componentA.invoke_procedure(self.profileB, 'helloworld', args=args)
    ...
    def test_sending_tags(self):
        ...
        self.componentB.add_procedure('helloworld', on_helloworld)
        self.componentA.invoke_procedure(self.profileB, 'helloworld', tags=tags)
    ...
    def test_sending_bytes_via_payloads(self):
        ...
        self.componentB.add_procedure('helloworld', on_helloworld)
        self.componentA.invoke_procedure(self.profileB, 'helloworld', payloads=payloads)
