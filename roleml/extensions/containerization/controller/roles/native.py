    ...
    def _advice_after_remove_from_relationship(self, activity: InvocationActivity, _):
        ...
        for instance_name in self.base.container_manager.containerized_roles:
            self.call(
                self.base.get_containerized_role_id(instance_name),
                'update-relationship',
                {'relationship_name': relationship_name, 'op': 'remove', 'instances': instances}
            )
    ...
    def add_relationship_link(self, _, from_relationship_name: str, to_relationship_name: str):
        ...
        for instance_name in self.base.container_manager.containerized_roles:
            self.call(
                ...
                {'from_relationship_name': from_relationship_name, 'to_relationship_name': to_relationship_name}
            )
